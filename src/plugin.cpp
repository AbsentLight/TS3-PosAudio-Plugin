...
const char* ts3plugin_description() {
	/* If you want to use wchar_t, see ts3plugin_name() on how to use */
    return "Plugin for use with PaperPAT to give positional audio for MC.";
}
...
void ts3plugin_initHotkeys(struct PluginHotkey*** hotkeys) {
	...
	CREATE_HOTKEY("enableposaud", "Enable positional audio");
	CREATE_HOTKEY("disableposaud", "Disable positional audio");
	END_CREATE_HOTKEYS;
